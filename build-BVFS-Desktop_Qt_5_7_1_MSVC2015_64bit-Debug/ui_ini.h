...
public:
    ...
    void setupUi(QMainWindow *iNI)
    {
        ...
        gridLayout->addWidget(refresh, 8, 1, 1, 1);
        ...
        menubar->setGeometry(QRect(0, 0, 774, 23));
    ...
    void retranslateUi(QMainWindow *iNI)
    {
        ...
        refresh->setText(QApplication::translate("iNI", "\345\210\267\346\226\260", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem = tableWidget->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("iNI", "iNodeId", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem1 = tableWidget->horizontalHeaderItem(1);
        ___qtablewidgetitem1->setText(QApplication::translate("iNI", "fileCount", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem2 = tableWidget->horizontalHeaderItem(2);
        ___qtablewidgetitem2->setText(QApplication::translate("iNI", "fileMode", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem3 = tableWidget->horizontalHeaderItem(3);
        ___qtablewidgetitem3->setText(QApplication::translate("iNI", "userId", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem4 = tableWidget->horizontalHeaderItem(4);
        ___qtablewidgetitem4->setText(QApplication::translate("iNI", "diskAddress", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem5 = tableWidget_3->horizontalHeaderItem(0);
        ___qtablewidgetitem5->setText(QApplication::translate("iNI", "SFDInode", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem6 = tableWidget_3->horizontalHeaderItem(1);
        ___qtablewidgetitem6->setText(QApplication::translate("iNI", "\346\226\207\344\273\266\357\274\210\347\233\256\345\275\225\357\274\211", Q_NULLPTR));
        ...
        ___qtablewidgetitem8->setText(QApplication::translate("iNI", "\347\224\250\346\210\267\345\220\215", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem9 = tableWidget_2->horizontalHeaderItem(1);
        ___qtablewidgetitem9->setText(QApplication::translate("iNI", "\345\257\206\347\240\201", Q_NULLPTR));
        QTableWidgetItem *___qtablewidgetitem10 = tableWidget_2->horizontalHeaderItem(2);
        ___qtablewidgetitem10->setText(QApplication::translate("iNI", "iNode", Q_NULLPTR));
    } // retranslateUi
